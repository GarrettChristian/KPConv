...
class S3DISDataset(Dataset):
    ...
    def __init__(self, input_threads=8):
        ...
        if 'SSH_CLIENT' in os.environ.keys():
            self.path = '/home/hugues/Data/S3DIS/Stanford3dDataset_v1.2'
        else:
    ...
    def load_multi_clouds(self, min_scale, val_scale):
        ...
        for i, file_path in enumerate(self.train_files):
            ...
            # Check if inputs have already been computed
            if isfile(KDTree_file):
                print('\nFound KDTree for cloud {:s}, subsampled at {:.3f}'.format(cloud_name, subsampling_scale))
                ...
                print('\nPreparing KDTree for cloud {:s}, subsampled at {:.3f}'.format(cloud_name, subsampling_scale))
