                              ...
                              int max_p)
{
	...
	for (b = 0; b < original_batches.size(); b++)
	{
        ...
        {
            b_o_classes = vector<int>(original_classes.begin () + sum_b,
                                      original_classes.begin () + sum_b + original_batches[b]);
	    }
        ...
        // If too many points shuffle and remove random
        ...
        else
        {
            ...
            if (original_classes.size() > 0)
                subsampled_classes.insert(subsampled_classes.end(), b_s_classes.begin(), b_s_classes.begin() + max_p);
